    ...
    def _check_meta(self, text: str) -> str | None:
        ...
        if s == "/models":
            return (
                ...
                "    openai/gpt-oss-120b            Best overall — smart, fast, strong reasoning\n"
                "    openai/gpt-oss-20b             Fastest — use for quick tasks and short answers\n"
                "    (legacy llama-3.x models were deprecated by Groq on 2026-06-17)\n\n"
                ...
                "  RECOMMENDATION:\n"
                "    Everyday chat        → openai/gpt-oss-120b (smart default)\n"
                "    Need to think hard   → openai/gpt-oss-120b (raise reasoning effort)\n"
                "    Long document/image  → gemini-2.0-flash-exp\n"
                "    Speed over quality   → openai/gpt-oss-20b\n\n"
